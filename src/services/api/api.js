...
export async function updateWorkspace(body) {
    const response = await apiFetch(`${CONFIG.API_URL}/workspaces/${body.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(body),
    });
...
export async function requestAccess(code) {
    const response = await apiFetch(`${CONFIG.API_URL}/invite/access`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
export async function createAccess(body) {
    const response = await apiFetch(`${CONFIG.API_URL}/invite/create`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(body),
    });
...
export async function delteAccess(body) {
    const response = await apiFetch(`${CONFIG.API_URL}/invite/leave`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(body),
    });
